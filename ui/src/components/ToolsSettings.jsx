...
function ToolsSettings({ isOpen, onClose }) {
  ...
  const availableModels = [
    { value: 'qwen-2.5-72b-instruct', label: 'Qwen 2.5 72B Instruct', description: 'Large and powerful model (Recommended)' },
    { value: 'qwen-2.5-32b-instruct', label: 'Qwen 2.5 32B Instruct', description: 'Balanced model for most tasks' },
    { value: 'qwen-2.5-14b-instruct', label: 'Qwen 2.5 14B Instruct', description: 'Faster model for simple tasks' }
  ];
