          ...
          {!isGrouped && (
            <div className="flex items-center space-x-2 mb-1">
              ...
              <div className="text-xs font-medium text-gray-900 dark:text-white">
                {message.type === 'error' ? 'Error' : 'Dekacode'}
              </div>
            </div>
          )}
      ...
      switch (latestMessage.type) {
        ...
        case 'gemini-response':
          ...
          if (Array.isArray(messageData.content)) {
            ...
            // For dekacode: accumulate streaming content instead of creating separate messages
            setChatMessages(prev => {
              const lastMessage = prev[prev.length - 1];

              // If the last message is from assistant and recent (within 5 seconds), append to it
              if (lastMessage &&
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center text-gray-500 dark:text-gray-400">
          <p>Select a project to start chatting with Dekacode</p>
        </div>
      </div>
    );
  }
        ...
        {isLoadingSessionMessages && chatMessages.length === 0 ? (
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center text-gray-500 dark:text-gray-400 px-6 sm:px-4">
              <p className="font-bold text-lg sm:text-xl mb-3">Start a conversation with Dekacode</p>
          ...
          <div className="chat-message assistant">
            <div className="w-full">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <div className="text-sm font-medium text-gray-900 dark:text-white">Dekacode</div>
          ...
          <div className="flex items-center justify-center gap-3">
            <div className={`px-4 py-1.5 rounded-lg text-sm font-medium border transition-all duration-200 ${
              ...
              <div className="flex items-center gap-2">
                ...
                <span>{isYoloMode ? 'Dekacode YOLO' : 'Dekacode Default'}</span>
        ...
        <form onSubmit={handleSubmit} className="relative max-w-4xl mx-auto">
          ...
          <div {...getRootProps()} className={`chat-input-container relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-600 focus-within:ring-2 focus-within:ring-blue-500 dark:focus-within:ring-blue-500 focus-within:border-blue-500 transition-all duration-200 ${isTextareaExpanded ? 'chat-input-expanded' : ''}`}>
            ...
            <textarea
              ...
              placeholder="Ask Dekacode to help with your code... (@ to reference files)"
              disabled={isLoading}
              rows={1}
